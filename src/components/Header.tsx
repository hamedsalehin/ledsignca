    ...
    <header className="w-full">
      ...
      <div className="bg-white border-b border-gray-150 text-gray-500 text-xs py-1.5 font-medium">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-end gap-4 md:gap-6">
          <Link
            href="/signs-supply"
            className="flex items-center gap-1.5 hover:text-yellow-600 transition-colors duration-200 font-bold text-[#b020ff]"
            aria-label="Signs Supply"
          >
            <Package className="w-4 h-4" />
            <span>Signs Supply</span>
          </Link>
          <Link
            href="/design"
