...
export function ContactSection() {
  ...
  return (
    <section id="contact" className="relative pt-6 pb-12 bg-grid scroll-mt-12">
      <div className="w-full px-6 sm:px-12 md:px-16 lg:px-24 xl:px-32 2xl:px-44">
        <div className="text-center mb-8">
          ...
          <p className="text-xs sm:text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed mt-1">
            Have a project in mind? Our team of experts will provide a tailored solution and competitive pricing within 24 hours.
          </p>
        </div>
            ...
            <div className="bg-card rounded-xl border border-border p-6 card-glow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">info@led-sign.ca</p>
                </div>
              </div>
            </div>
            <div className="bg-card rounded-xl border border-border p-6 card-glow">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">+1 416-838-8994</p>
                </div>
              </div>
            </div>
            <div className="bg-card rounded-xl border border-border p-6 card-glow">
