...
- Dynamic Visual Impact: High-resolution UV printing at 1440 DPI delivers vivid, fade-resistant colors that command attention across crowded halls.`,
    ...
    products: [
      {
        ...
        description: "Durable corrugated plastic yard signs perfect for bulk campaigns.",
        image: "/bag yard signs.png",
  ...
  "signs-supply": {
    title: "Signs Supply (Wholesale)",
    breadcrumbLabel: "Signs Supply",
    heroSubtitle: "Premium Raw Materials for Signmakers",
    description: "Top-quality sign making supplies including A-frames, banners, power supplies, LED modules, and silicone neon strips.",
    heroImage: "/images/products/signs-supply/power-supply-12v.jpeg",
    categoryDescriptionText: "We stock reliable components and materials to help you build outstanding signs.",
    products: [
      { 
        id: "a-frame-sign", 
        name: "Black Metal Slide-in Folding A Frame Sign 24x36In Double-Sided", 
        description: "Heavy-Duty Coated Steel Frame Sidewalk Curb Sign (Frame only)", 
        image: "/images/products/signs-supply/a-frame-sign.jpeg", 
        price: "$45.00", 
        badge: "Essential",
        customConfig: {
          keyFeatures: [
            "24x36 SLIDE-IN DISPLAY: Top-loading slide-in channel for fast changes",
            "HEAVY-DUTY COATED STEEL FRAME: Corrosion & weather-resistant",
            "STABLE FOOTPRINT: 41in tall x 24.2in wide with a 28in wide base",
            "NON-SLIP RUBBER FEET: Grips pavement, tile, and wet sidewalks",
            "DOUBLE-SIDED: Maximize visibility from both directions"
          ],
          specs: [
            { key: "Size", value: "24x41 inch (Frame only)" },
            { key: "Color", value: "Black" },
            { key: "Material", value: "Iron/Steel" },
            { key: "Mounting Type", value: "Floor Standing" },
            { key: "Item Weight", value: "15 pounds" }
          ],
          sizes: [
            { label: "36x24", value: "36x24", basePrice: 45 }
          ],
          images: [
            "/images/products/signs-supply/a-frame-sign.jpeg",
            "/images/products/signs-supply/a-frame-sign-2.jpeg",
            "/images/products/signs-supply/a-frame-sign-3.jpeg",
            "/images/products/signs-supply/a-frame-sign-4.jpeg"
          ]
        }
      },
      { 
        id: "roll-up-banner", 
        name: "Retractable Banner Stand 33\"x79\" Base, Metal Stand Replacement + Black Bag", 
        description: "Roll Up Stand Aluminum Trade Show/Event/Photo Booth (Base Only No Print)", 
        image: "/images/products/signs-supply/roll-up-banner.png", 
        price: "$39.00",
        badge: "Popular",
        customConfig: {
          keyFeatures: [
            "DIY GRAPHIC REPLACEMENT: Includes step-by-step instructional flyer — change your banner yourself in minutes",
            "CONVERTIBLE BACKPACK BAG: Heavy-duty black carrying bag converts into a backpack for hands-free transport",
            "FLEXIBLE SIZE OPTIONS: Choose between 33\"x80\" and 46\"x80\" — compatible with vinyl, fabric, and thin-film media",
            "RAPID 1-DAY READINESS: Quick-deployment features for urgent pop-up events and marketing campaigns",
            "PROFESSIONAL FINISH: Clean silver finish integrates into trade shows, retail, corporate lobbies, and exhibit halls"
          ],
          specs: [
            { key: "Color", value: "Silver Stand" },
            { key: "Material", value: "Aluminum / Metal" },
            { key: "Item Weight", value: "4.5 pounds" },
            { key: "Dimensions (L x W x H)", value: "33 x 81 x 0.4 inches" },
            { key: "Contents", value: "Base + Carrying Bag + Instruction Flyer" },
            { key: "Print", value: "Not included (Base Only)" }
          ],
          sizes: [
            { label: "35 Inches (33\"x79\")", value: "35in", basePrice: 39 },
            { label: "46 Inches (46\"x80\")", value: "46in", basePrice: 89 }
          ]
        }
      },
      { 
        id: "power-supply-12v", 
        name: "12V LED Power Supply", 
        description: "Waterproof Transformer (60W/100W)", 
        image: "/images/products/signs-supply/power-supply-12v.jpeg", 
        price: "$25.00", 
        badge: "Reliable" 
      },
      { 
        id: "s-strip-silicon-neon", 
        name: "S-Type Silicone Neon Strip", 
        description: "Flexible LED Neon Rope Light (12V)", 
        image: "/images/products/signs-supply/s-strip-silicone-neon.jpeg", 
        price: "$35.00", 
        badge: "New" 
      },
      { 
        id: "led-module-white", 
        name: "LED Display Modules (p5,p3.9.p2.6)", 
        description: "Bright White 12V Modules for Channel Letters", 
        image: "/images/products/signs-supply/led-display-modules.png", 
        price: "$0.50" 
      }
    ].map((p: any) => ({
      ...p,
      config: {
        title: p.name,
        subtitle: p.description,
        breadcrumb: "Signs Supply",
        breadcrumbHref: "/signs-supply",
        promoText: "WHOLESALE PRICING FOR SIGNMAKERS",
        image: p.image,
        images: p.customConfig?.images || undefined,
        sizes: p.customConfig?.sizes || [
          { label: "Standard", value: "standard", basePrice: parseFloat(p.price.replace(/[^0-9.]/g, "")) || 0 }
        ],
        selects: [],
        qtyDiscount: "Bulk discounts available for orders over 50 units.",
        keyFeatures: p.customConfig?.keyFeatures || ["Trade quality", "Durable materials", "Fast shipping for signmakers"],
        useCases: p.customConfig?.useCases || ["Sign fabrication", "Retail displays", "Outdoor advertising"],
        specs: p.customConfig?.specs || [],
        faqs: [],
        reviews: [],
        ctaHeading: "Stock up on supplies",
        ctaLabel: "Add to Cart"
      }
    }))
  },
