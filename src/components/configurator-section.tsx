...
`.trim()
  ...
  const handleAddToCart = () => {
    ...
    addItem({
      productTitle: `Custom LED Display ${width}x${height} mod`,
      size: `${width}x${height} modules`,
      quantity: 1,
      unitPrice: calculation.total,
      totalPrice: calculation.total,
      customOptions: { config: `${pp.label} | ${env.label} | ${cab.label}` },
    })
  }

  return (
    <section id="configurator" className="relative pt-6 pb-12 bg-secondary/20 scroll-mt-12">
